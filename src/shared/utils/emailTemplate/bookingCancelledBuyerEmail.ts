export const bookingCancelledBuyerEmail = (data: {
  buyerName: string;
  bookingId: string;
  agentName: string;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background-color:#c0392b;padding:32px;text-align:center;">
              ...
              <p style="margin:8px 0 0;color:#f5b7b1;font-size:14px;">Your property viewing has been cancelled</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;color:#555555;font-size:15px;line-height:1.6;">
                We regret to inform you that your property viewing has been <strong style="color:#c0392b;">cancelled by the agent</strong>. We apologise for any inconvenience this may have caused.
              </p>
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0;color:#e67e22;font-size:14px;line-height:1.6;">
                      <strong>What's next?</strong> You can browse other available properties and schedule a new viewing at any time through the app.
                    </p>
                  </td>
                </tr>
              </table>
